...
The contract must not contain complete chat transcripts, hidden reasoning, credentials, environment-variable values, or embedded source files.
...
All product-design questions required for an implementation plan are resolved. Implementation remains blocked only on the owner's review of this written specification.
